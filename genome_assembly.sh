...
supernova run \--id=SFS_longreadassembly \--fastqs=SFS_fastq \--maxreads='all'
...
nohup java -jar /Trimmomatic-0.39/trimmomatic-0.39.jar PE SFS_CC1_R1.fastq.gz SFS_CC1_R2.fastq.gz SFS_CC1_R1_Trimmed.fastq.gz SFS_CC1_R1_Unpaired.fastq.gz SFS_CC1_R2_Trimmed.fastq.gz SFS_CC1_R2_Unpaired.fastq.gz ILLUMINACLIP:/Trimmomatic-0.39/adapters/TruSeq3-PE-2.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36 &
...
nohup /kraken2_dir/kraken2 --gzip-compressed --db /kraken2-2.1.1/kraken2_dir/bacteriaDB --paired --unclassified-out NFS_50254_unclass#.fastq.gz SFS_CC1_R1_Trimmed.fastq.gz SFS_CC1_R2_Trimmed.fastq.gz --report SFS_CC1Report --use-names &
1
...
8) BUSCO on long read asssembly
